...
error-estimate-format = We accept Excel (xlsx, xls) and a photo of the estimate (jpg, png, webp)
error-estimate-photo-off = Photo recognition is unavailable right now — please send the estimate as an Excel file
error-estimate-photo-needs-email = To send a photo, confirm your email address — we have sent you a link
error-estimate-not-a-photo = The file does not look like a photo — please take the picture again
...
error-estimate-photo-unreadable = We could not read the estimate on the photo — take it again in good light so that every row fits in the frame
error-estimate-later = We could not parse the estimate this time — please upload it again later
